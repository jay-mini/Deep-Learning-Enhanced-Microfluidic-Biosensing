...
def plot_fluorescence_statistics(log_labels, mean_values, std_values):
    ...
    predicted_values = (predicted_values - 1) * 10
    mean_values = (mean_values - 1) * 10
    std_values = np.array(std_values) * 10
...
if __name__ == '__main__':
    ...
    df.to_excel(os.path.join(main_directory, 'fluorescence_data.xlsx'), index=False)
